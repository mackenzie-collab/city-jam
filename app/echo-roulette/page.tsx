    ...
    return (
      <AppChrome>
        <div className="min-h-screen bg-cj-purple">
          <PageHeader title="Echo Roulette" icon={Crosshair} backHref="/community" />
    ...
    <AppChrome>
      <div className="min-h-screen bg-cj-purple">
        ...
        <div className="mx-auto max-w-4xl px-6 py-10">
          <AppTrail />
          <p className="text-xs uppercase tracking-widest text-cj-gold-muted">How do you want in?</p>
          <h1 className="cj-heading-display mt-2 text-4xl md:text-6xl">Pick Your Role</h1>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <h2 className="font-display text-2xl uppercase text-cj-gold">Tune In</h2>
              <p className="mt-3 text-sm text-cj-gold-muted">
                Spin the dial, land on a frequency, and connect with whoever&apos;s broadcasting.
              </p>
            ...
            >
              ...
              <h2 className="font-display text-2xl uppercase text-cj-gold">Go Live</h2>
              <p className="mt-3 text-sm text-cj-gold-muted">
