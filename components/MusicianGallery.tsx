...
const COVER_PLACEHOLDERS = [
  { label: "Midnight Sessions", hue: "from-wax-burgundy/40 to-cj-purple-card" },
  ...
  { label: "Groove Archive", hue: "from-cj-purple-dark to-dust-grey" },
];
  ...
  return (
    <section className="overflow-hidden bg-cj-purple-dark py-12 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        <p className="mb-2 text-center font-headline text-lg uppercase text-cj-gold">On the scene</p>
        <p className="cj-label-stamp mb-6 text-center sm:mb-8">
          Every kind of musician. One frequency.
        </p>
      </div>
      <div className="cj-gatefold mx-4 overflow-hidden sm:mx-6 md:mx-8">
                ...
                <CoverArtFrame
                  ...
                  fallback={
                    ...
                    >
                      ...
                      <span className="cj-label-stamp mt-auto text-[9px]">
                        {cover.label}
                      </span>
                    </div>
                  }
