      ...
      <nav className="cj-header flex w-full items-center justify-between gap-3 px-4 py-3 sm:px-6 md:px-8">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md text-cj-text-muted hover:bg-cj-surface-elevated hover:text-cj-text lg:hidden"
            ...
            return (
              ...
              <Link
                ...
                className={cn(
                  ...
                  "text-sm font-medium no-underline transition-colors hover:text-cj-gold",

                  active || link.highlight

                    ? "cj-nav-tab-active text-cj-text"
          ...
          {!loading && isAuthenticated ? (
            ...
            <>
              ...
              <Link
                ...
                className="hidden items-center gap-1.5 text-sm font-medium text-cj-text-muted no-underline hover:text-cj-text sm:flex"
            ...
            <>
              ...
              <Link href="/register" className="no-underline">
                ...
                <span className="cj-label-sticker px-4 py-2 text-sm">
