  ...
  return (
    <AppChrome>
      <div className="relative min-h-screen bg-cj-purple-map">
        ...
        <div className="relative h-[calc(100vh-120px)] w-full overflow-hidden pb-20">
          <div
            ...
            <div className="text-xs text-cj-gold-muted">
              {visible && yourCity ? (
                <p>
                  ...
                  {yourCity.onlineCount} nearby
                </p>
              ) : loading ? (
                <p>Locating you on the map…</p>
              ) : (
                <p>Neighborhood-level only · no exact location</p>
              )}
              {geoError && (
                <p className="mt-1 text-cj-gold-bright/80">
                  {geoError}
                  {!visible && isAuthenticated && (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={appearOnMap}
                        className="underline hover:text-cj-gold"
                      >
                        Retry
                      </button>
                    </>
              ...
              <Link href="/community" className="mt-1 block text-[10px] uppercase tracking-widest hover:text-cj-gold">
                ← Back to Community
              </Link>
            </div>
