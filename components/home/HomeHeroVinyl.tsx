...
export default function HomeHeroVinyl() {
  return (
    <div className="affiliate-hero-vinyl" aria-hidden>
      <div className="affiliate-hero-vinyl__disc">
        <svg viewBox="0 0 400 400" className="affiliate-hero-vinyl__svg">
          <defs>
            <radialGradient id="home-vinyl-fill" cx="34%" cy="30%" r="70%">
              <stop offset="0%" stopColor="#3d0052" />
              <stop offset="45%" stopColor="#1a0024" />
              <stop offset="100%" stopColor="#0a0a0a" />
            </radialGradient>
            <radialGradient id="home-vinyl-shine" cx="28%" cy="22%" r="45%">
              <stop offset="0%" stopColor="rgba(208, 207, 136, 0.14)" />
              <stop offset="100%" stopColor="rgba(208, 207, 136, 0)" />
            </radialGradient>
            <linearGradient id="home-label-fill" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#5c007a" />
              <stop offset="100%" stopColor="#2d003e" />
            </linearGradient>
          </defs>

          <circle cx="200" cy="200" r="198" fill="url(#home-vinyl-fill)" />
          <circle cx="200" cy="200" r="198" fill="url(#home-vinyl-shine)" />
          <circle
            cx="200"
            cy="200"
            r="197"
          ...
          <circle cx="200" cy="200" r="112" fill="url(#home-label-fill)" />
          <circle
            cx="200"
            cy="200"
            r="112"
